...
function vw_spa_lite_categorized_blog() {
	if ( false === ( $vw_spa_lite_all_the_cool_cats = get_transient( 'vw_spa_lite_all_the_cool_cats' ) ) ) {
		// Create an array of all the categories that are attached to posts
		$vw_spa_lite_all_the_cool_cats = get_categories( array(
			'hide_empty' => 1,
		) );

		// Count the number of categories that are attached to the posts
		$vw_spa_lite_all_the_cool_cats = count( $vw_spa_lite_all_the_cool_cats );

		set_transient( 'vw_spa_lite_all_the_cool_cats', $vw_spa_lite_all_the_cool_cats );
	}

	if ( '1' != $vw_spa_lite_all_the_cool_cats ) {
...
function vw_spa_lite_category_transient_flusher() {
	// Like, beat it. Dig?
	delete_transient( 'vw_spa_lite_all_the_cool_cats' );
}
