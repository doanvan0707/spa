...
<?php do_action( 'vw_spa_lite_above_slider' ); ?>

	<?php
		// Get pages set in the customizer (if any)
		$pages = array();
		for ( $count = 1; $count <= 5; $count++ ) {
		$mod = intval( get_theme_mod( 'vw_spa_lite_slidersettings-page-' . $count ));
	...
	?>
<?php do_action( 'vw_spa_lite_after_slider' ); ?>
...
<section id="amazing-service" class="darkbox" >
    ...
    <?php } ?>
    <?php do_action( 'vw_spa_lite_after_service' ); ?>
	<div class="container">
		<div class="row">
			<?php 
			  		...
			  		<div class="col-md-4 col-sm-4">
			  			<div class="amazing-box">
					    	...
					    	<div class="amaze-con-box">
					    		<h4><?php the_title(); ?></h4>
					    		<p><?php the_excerpt(); ?></p>
					    		<a class="r_button"  href="<?php the_permalink(); ?>"><?php esc_html_e('Read More','vw-spa-lite'); ?></a>  
					    	</div>
					    </div>
				    </div>
				<?php endwhile;
...
<?php do_action( 'vw_spa_lite_after_ourservices' ); ?>
